...
def generate_testcase_2():
    N = 10
    array_data = [random.randint(0, 10) for _ in range(N)]
    write_array_to_file('testcases/2.in', N, array_data)

def generate_testcase_3():
    N = 10
    array_data = [random.randint(-10, 0) for _ in range(N)]
...
def generate_testcase_10():
    N = 1000000
    array_data = [random.randint(-10, -1) for _ in range(N)]
...
def generate_testcase_13():
    N = 10000000
    array_data = [random.randint(1, 10) for _ in range(N)]
